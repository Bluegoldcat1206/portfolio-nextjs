const projects = [
  {
    ...
    description: "A poster project based on CDA Lake at Sunset. This project included research, sketching, and digital design.",
  ...
  },
  {
    ...
    description: "A poster in the Art Nouveau style featuring a woman figure and bike. Focused on history and digital painting.",
  ...
  },
  {
    ...
    slug: "first-hobby-logo",
    year: "2025",
    summary: "The first logo I created for an imaginary coffee shop.",
    description: "The first logo I created, designed for an imaginary coffee shop called Cool Beans. This was my introduction to logo design.",
  ...
  },
  {
    ...
    slug: "christmas-menu-board",
    year: "2025",
    summary: "A Menu board design idea for a coffee shop, with Christmas illustrations.",
    description: "A festive menu board design for a coffee shop featuring Christmas illustrations and hand-lettered typography.",
  ...
  },
  {
    ...
    description: "A poster composed entirely of type and letters, exploring typography and layout design.",
  ...
  },
  {
    ...
    description: "A repeating pattern made from original icons, themed around the Pumpkin Spice Life aesthetic.",
